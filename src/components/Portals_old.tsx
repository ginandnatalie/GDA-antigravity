...
// ิ๖วิ๖วิ๖ว UTILITY: CSV Export ิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖ว
...
// ิ๖วิ๖วิ๖ว UTILITY: AI Match Score Badge ิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖ว
...
// ิ๖วิ๖วิ๖ว ADMIN DASHBOARD (MAIN) ิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖ว
export function AdminDashboard() {
  ...
  // ิ๖วิ๖วิ๖ว CMD+K Shortcut ิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖ว
  useEffect(() => {
  ...
  // ิ๖วิ๖วิ๖ว BULK ACTIONS ิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖ว
  ...
  // ิ๖วิ๖วิ๖ว FILTERED + SORTED DATA ิ๖วิ๖วิ๖วิ๖วิ๖ว
  ...
  // ิ๖วิ๖วิ๖ว STATS ิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖ว
  const stats = useMemo(() => ({
  ...
  return (
    <div className="p-8 max-w-7xl mx-auto">
      {/* ิ๖วิ๖วิ๖ว CMD+K Command Palette ิ๖วิ๖วิ๖ว */}
      {showCommandPalette && (
        <div className="fixed inset-0 z-[5000] bg-bg/90 backdrop-blur-md flex items-start justify-center pt-[15vh]" onClick={() => setShowCommandPalette(false)}>
          <div className="bg-card border border-border-custom rounded-2xl w-full max-w-lg shadow-2xl overflow-hidden" onClick={e => e.stopPropagation()}>
            <div className="p-4 border-b border-border-custom flex items-center gap-3">
              <span className="text-text-muted text-lg">ญ๖์</span>
              <input
                autoFocus
            ...
            <div className="p-2 max-h-60 overflow-y-auto">
              {[
                { label: 'View Applications', icon: 'ญ๔ุ', action: () => { setActiveTab('applications'); setShowCommandPalette(false); } },
                { label: 'Manage Courses', icon: 'ญ๔Ü', action: () => { setActiveTab('courses'); setShowCommandPalette(false); } },
                { label: 'Student Progress', icon: 'ญ๔่', action: () => { setActiveTab('progress'); setShowCommandPalette(false); } },
                { label: 'Staff Management', icon: 'ญๆั', action: () => { setActiveTab('staff'); setShowCommandPalette(false); } },
                { label: 'Site Settings', icon: 'ิÜึดฉล', action: () => { setActiveTab('settings'); setShowCommandPalette(false); } },
                { label: 'Communication Logs', icon: 'ญ๔บ', action: () => { setActiveTab('communications'); setShowCommandPalette(false); } },
                { label: 'Export All Applications (CSV)', icon: 'ญ๔๑', action: () => { exportToCSV(applications, 'gda-applications'); setShowCommandPalette(false); } },
              ].map((item, i) => (
                <button
                  key={i}
                  onClick={item.action}
          ...
          <div className="flex justify-between items-end mb-8">
            <div>
              <div className="flex items-center gap-3 mb-3">
                ...
                >
                  <span className="text-sm">ญ๖์</span>
      ...
      {/* ิ๖วิ๖วิ๖ว APPLICATION DETAIL MODAL ิ๖วิ๖วิ๖ว */}
      {selectedApp && (
        <div className="fixed inset-0 z-[3000] bg-bg/90 backdrop-blur-sm flex items-center justify-center p-6" onClick={() => setSelectedApp(null)}>
          <div className="bg-card border border-border-custom rounded-2xl w-full max-w-lg max-h-[80vh] overflow-y-auto p-8 relative" onClick={e => e.stopPropagation()}>
            <button className="absolute top-4 right-4 text-text-muted hover:text-text-custom" onClick={() => setSelectedApp(null)}>ิฃ๒</button>
...
// ิ๖วิ๖วิ๖ว COMMUNICATION LOGS ิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖ว
  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        ...
        <button onClick={() => exportToCSV(logs, 'gda-communications')} className="btn btn-outline btn-sm">ญ๔๑ Export CSV</button>
      </div>
...
// ิ๖วิ๖วิ๖ว STAFF MANAGEMENT ิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖ว
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-2">
          <button onClick={() => exportToCSV(staff, 'gda-staff')} className="btn btn-outline btn-sm">ญ๔๑ Export</button>
...
// ิ๖วิ๖วิ๖ว SITE SETTINGS ิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖ว
function SiteSettings() {
  const [settings, setSettings] = useState({
    ...
    ctaSubtitle: 'Applications for the April 2026 cohort close soon. Seats are limited to 25 per cohort ิว๖ secure yours now.'
  });
  const [loading, setLoading] = useState(true);
...
// ิ๖วิ๖วิ๖ว COURSE MANAGER ิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖ว
function CourseManager({ courses, onRefresh, onEditContent }: { courses: any[], onRefresh: () => void, onEditContent: (course: any) => void }) {
  const [isAdding, setIsAdding] = useState(false);
  const [newCourse, setNewCourse] = useState({ title: '', description: '', slug: '', thumbnail_url: 'ญ๔ÿ' });
  ...
  async function handleAddCourse(e: React.FormEvent) {
    ...
    try {
      ...
      if (error) throw error;
      setIsAdding(false);
      setNewCourse({ title: '', description: '', slug: '', thumbnail_url: 'ญ๔ÿ' });
      onRefresh();
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-2">
          <button onClick={() => exportToCSV(courses, 'gda-courses')} className="btn btn-outline btn-sm">ญ๔๑ Export</button>
        ...
        {courses.map(course => (
          <div key={course.id} className="bg-card border border-border-custom rounded-xl p-6 hover:border-gold/30 transition-all group">
            ...
            <div className="flex justify-between items-center pt-4 border-t border-border-custom">
              ...
              <button onClick={() => onEditContent(course)} className="text-gold text-[11px] font-bold hover:underline">Manage Content ิๅฦ</button>
            </div>
          </div>
        ))}
      </div>
...
// ิ๖วิ๖วิ๖ว COURSE CONTENT EDITOR ิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖ว
  ...
  return (
    <div className="space-y-8">
      <div className="flex items-center gap-4">
        <button onClick={onBack} className="p-2 rounded-full hover:bg-surface border border-border-custom">ิๅษ</button>
        <div>
        ...
        <div className="lg:col-span-2">
          {editingLesson ? (
            ...
            <div className="bg-card border border-border-custom border-dashed rounded-xl p-20 text-center">
              <div className="text-4xl mb-4">ญ๔ุ</div>
...
// ิ๖วิ๖วิ๖ว NEWS MANAGER (CMS) ิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖ว
...
// ิ๖วิ๖วิ๖ว EVENTS MANAGER ิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖ว
    ...
    <div className="space-y-6">
      ...
      {isEditing ? (
        ...
        <div className="bg-card border border-border-custom rounded-xl p-6 space-y-6">
          <div className="flex justify-between items-start">
            <div>
              <button onClick={() => setSelectedEvent(null)} className="text-gold text-[10px] uppercase font-bold mb-2">ิๅษ Back to List</button>
            ...
            <button onClick={() => exportToCSV(regs, `registrations-${selectedEvent.id}`)} className="btn btn-gold btn-sm">ญ๔ั Export CSV</button>
          </div>
...
// ิ๖วิ๖วิ๖ว FINANCE MANAGER (ADMIN) ิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖ว
...
// ิ๖วิ๖วิ๖ว MY FINANCE (STUDENT) ิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖ว
function MyFinance() {
  const { user } = useAuth();
  const [invoices, setInvoices] = useState<any[]>([]);
  const [txs, setTxs] = useState<any[]>([]);
            ...
            {txs.map(tx => (
              <div key={tx.id} className="flex items-center gap-4 p-4 border-b border-border-custom">
                ...
                <div className="flex-1">
                  ...
                  <div className="text-[10px] text-text-muted uppercase tracking-widest">{tx.payment_method} ิว๓ {tx.reference}</div>
                </div>
...
// ิ๖วิ๖วิ๖ว STUDENT PORTAL ิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖วิ๖ว
export function StudentPortal({ onStartCourse }: { onStartCourse: (courseId: string) => void }) {
  ...
  return (
    <div className="p-6 md:p-8 max-w-6xl mx-auto">
      {/* ิ๖วิ๖วิ๖ว PORTAL HEADER ิ๖วิ๖วิ๖ว */}
      ...
      {/* ิ๖วิ๖วิ๖ว PORTAL TABS ิ๖วิ๖วิ๖ว */}
      <div className="flex gap-4 mb-8 border-b border-border-custom overflow-x-auto">
        {[
          { id: 'dashboard', label: 'ญ๔่ Dashboard', icon: '' },
          { id: 'courses', label: 'ญ๔Ü My Courses', icon: '' },
          { id: 'finances', label: 'ญฦฆ Finances', icon: '' },
          { id: 'applications', label: 'ญ๔ุ Applications', icon: '' },
          { id: 'profile', label: 'ญๆ๑ Profile', icon: '' },
          { id: 'settings', label: 'ิÜึดฉล Settings', icon: '' },
        ].map(tab => (
          <button
            key={tab.id}
      ...
      {activeSection === 'dashboard' && (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="md:col-span-3 bg-gold-dim border border-gold/20 rounded-xl p-6">
            <h3 className="font-syne font-bold text-lg mb-2 text-gold">ญ๔๏ Next Steps</h3>
            <p className="text-[13px] text-text-soft leading-relaxed">
              {applications.some(a => a.status === 'approved' && !enrollments.some(e => e.courses?.title === a.program))
                ...
                ? 'Continue where you left off ิว๖ pick a course from "My Courses" to keep progressing.'
      ...
      {/* ิ๖วิ๖วิ๖ว MY COURSES ิ๖วิ๖วิ๖ว */}
          ...
          {enrollments.map(enroll => (
            <div key={enroll.id} className="bg-card border border-border-custom rounded-xl p-6">
              <div className="flex justify-between items-center mb-4">
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-lg bg-surface flex items-center justify-center text-xl">{enroll.courses?.thumbnail_url || 'ญ๔ÿ'}</div>
                  <div>
                ...
                <div className="flex gap-2">
                  {progress[enroll.course_id] === 100 && (
                    <button onClick={() => setShowCertificate({ course: enroll.courses, profile })} className="btn btn-outline btn-sm">ญฤ๔ Certificate</button>
                  )}
      ...
      {/* ิ๖วิ๖วิ๖ว APPLICATIONS ิ๖วิ๖วิ๖ว */}
      ...
      {/* ิ๖วิ๖วิ๖ว FINANCES ิ๖วิ๖วิ๖ว */}
      {activeSection === 'finances' && <MyFinance />}

      {/* ิ๖วิ๖วิ๖ว SETTINGS ิ๖วิ๖วิ๖ว */}
      {activeSection === 'settings' && (
        <div className="max-w-xl space-y-6">
          ...
          <div className="bg-card border border-border-custom rounded-xl p-6 space-y-4">
            ...
            <button onClick={handlePasswordReset} className="btn btn-outline btn-sm">ญ๖ษ Reset Password</button>
          </div>

          <div className="bg-card border border-border-custom rounded-xl p-6 space-y-4">
            <h3 className="font-syne font-bold text-sm">Data & Privacy</h3>
            <button onClick={() => exportToJSON([profile || {}], 'my-gda-profile')} className="btn btn-outline btn-sm">ญ๔ั Download My Data</button>
      ...
      {/* ิ๖วิ๖วิ๖ว CERTIFICATE MODAL ิ๖วิ๖วิ๖ว */}
      {showCertificate && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
          <div className="bg-white text-black p-12 rounded-none shadow-2xl max-w-4xl w-full relative border-[20px] border-gold/20">
            <button onClick={() => setShowCertificate(null)} className="absolute top-4 right-4 text-black/40 hover:text-black">ิฃ๒</button>
            <div className="text-center border-4 border-gold/40 p-12">
              <div className="text-gold text-5xl mb-8">ญฤ๔</div>
            ...
            <div className="mt-8 flex justify-center gap-4">
              <button onClick={() => window.print()} className="btn bg-black text-white hover:bg-black/80">ญ๛ฟดฉล Print to PDF</button>
            </div>
          </div>
        </div>
      )}
...
// ิ๖วิ๖วิ๖ว STUDENT PROGRESS TRACKER (Admin View) ิ๖วิ๖วิ๖ว
  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        ...
        <button onClick={() => exportToCSV(students, 'gda-student-progress')} className="btn btn-outline btn-sm">ญ๔๑ Export CSV</button>
      </div>
      <div className="bg-card border border-border-custom rounded-xl overflow-hidden">
        <table className="w-full text-left border-collapse">
          <thead>
          ...
          <tbody>
            {students.map(item => (
              <tr key={item.id} className="border-b border-border-custom hover:bg-white/5 transition-colors">
                ...
                <td className="p-4">
                  {item.progress === 100 ? (
                    <span className="text-emerald text-[10px] font-bold flex items-center gap-1"><span className="text-sm">ญฤ๔</span> ISSUED</span>
                  ) : (
