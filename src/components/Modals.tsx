...
export function Modals({ activeModal, onClose, onLoginSuccess }: ModalsProps) {
  ...
  const [indForm, setIndForm] = useState({ first: '', last: '', email: '', phone: '', prog: '', qual: '', msg: '', dob: '', idNumber: '', gender: '', nationality: 'South Africa' });
    ...
    try {
      ...
      const { error } = await supabase.from('applications').insert([{
        ...
        history: JSON.stringify([{
          ...
          details: 'Submitted via Apply modal.'
        }])
      }]);
      ...
      setIndForm({ first: '', last: '', email: '', phone: '', prog: '', qual: '', msg: '', dob: '', idNumber: '', gender: '', nationality: 'South Africa' });
      setCvFile(null);
      onClose();
    } catch (err: any) {
      ...
      >
        ...
        {activeModal === 'apply' && (
          <>
            ...
            <div className="p-6 md:p-8">
              {applyTab === 'ind' && (
                <form className="flex flex-col gap-4" onSubmit={handleIndSubmit}>
                  {duplicateWarning && (
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="form-group">
                      <label className="block font-dm-mono text-[9px] tracking-[0.15em] uppercase text-text-muted mb-1.75">Date of Birth</label>
                      <input type="date" className="w-full bg-surface border border-border-custom rounded-sm p-2.75 px-3.5 font-dm-sans text-[13px] text-text-custom outline-none focus:border-gold/40 transition-all" value={indForm.dob} onChange={e => setIndForm({...indForm, dob: e.target.value})} />
                    </div>
                    <div className="form-group">
                      <label className="block font-dm-mono text-[9px] tracking-[0.15em] uppercase text-text-muted mb-1.75">Gender</label>
                      <select className="w-full bg-surface border border-border-custom rounded-sm p-2.75 px-3.5 font-dm-sans text-[13px] text-text-custom outline-none focus:border-gold/40 transition-all appearance-none" value={indForm.gender} onChange={e => setIndForm({...indForm, gender: e.target.value})}>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="form-group">
                      <label className="block font-dm-mono text-[9px] tracking-[0.15em] uppercase text-text-muted mb-1.75">SA ID / Passport</label>
                      <input type="text" className="w-full bg-surface border border-border-custom rounded-sm p-2.75 px-3.5 font-dm-sans text-[13px] text-text-custom outline-none focus:border-gold/40 transition-all" placeholder="9501015800088" value={indForm.idNumber} onChange={e => setIndForm({...indForm, idNumber: e.target.value})} />
                    </div>
                    <div className="form-group">
                      <label className="block font-dm-mono text-[9px] tracking-[0.15em] uppercase text-text-muted mb-1.75">Nationality</label>
                      <input type="text" className="w-full bg-surface border border-border-custom rounded-sm p-2.75 px-3.5 font-dm-sans text-[13px] text-text-custom outline-none focus:border-gold/40 transition-all" value={indForm.nationality} onChange={e => setIndForm({...indForm, nationality: e.target.value})} />
                    </div>
                  </div>
                  <div className="form-group">
                    <label className="block font-dm-mono text-[9px] tracking-[0.15em] uppercase text-text-muted mb-1.75">Email <span className="text-coral">*</span></label>
                  ...
                  <div className="form-group">
                    <label className="block font-dm-mono text-[9px] tracking-[0.15em] uppercase text-text-muted mb-1.75">Mobile</label>
                    <input type="tel" className="w-full bg-surface border border-border-custom rounded-sm p-2.75 px-3.5 font-dm-sans text-[13px] text-text-custom outline-none focus:border-gold/40 transition-all" placeholder="+27 XX XXX XXXX" value={indForm.phone} onChange={e => setIndForm({...indForm, phone: e.target.value})} />
                  </div>
                  <div className="form-group">
                  ...
                  <div className="form-group">
                    <label className="block font-dm-mono text-[9px] tracking-[0.15em] uppercase text-text-muted mb-1.75">Highest Qualification</label>
                    <select className="w-full bg-surface border border-border-custom rounded-sm p-2.75 px-3.5 font-dm-sans text-[13px] text-text-custom outline-none focus:border-gold/40 transition-all appearance-none" value={indForm.qual} onChange={e => setIndForm({...indForm, qual: e.target.value})}>
                      <option value="">Select…</option>
                  ...
                  <div className="form-group">
                    <label className="block font-dm-mono text-[9px] tracking-[0.15em] uppercase text-text-muted mb-1.75">Upload CV (PDF)</label>
                    <input 
                      type="file" 
                      accept=".pdf"
                      className="w-full bg-surface border border-border-custom rounded-sm p-2.75 px-3.5 font-dm-sans text-[13px] text-text-custom outline-none focus:border-gold/40 transition-all" 
