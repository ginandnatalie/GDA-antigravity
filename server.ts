            ...
            <div style="background-color: #11141d; border: 1px solid #1e2330; border-radius: 12px; padding: 32px; margin-bottom: 24px;">
              ...
              ${status === 'approved' ? `
                <div style="margin-top: 32px; text-align: center;">
                  <a href="${req.headers.origin || ''}/student-portal" style="display: inline-block; padding: 14px 28px; background-color: #D4AF37; color: #080b12; text-decoration: none; border-radius: 6px; font-weight: 800; font-size: 14px; text-transform: uppercase; letter-spacing: 1px;">Access Student Portal</a>
                </div>
              ` : ''}
            </div>
